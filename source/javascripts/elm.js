...
var _user$project$AlgoliaSearch$toLi = function (hit) {
	return A2(
		_elm_lang$html$Html$li,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text(hit.title),
			_1: {ctor: '[]'}
		});
};
var _user$project$AlgoliaSearch$toHtmlList = function (result) {
	return A2(
		_elm_lang$html$Html$ul,
		{ctor: '[]'},
		A2(_elm_lang$core$List$map, _user$project$AlgoliaSearch$toLi, result.hits));
};
var _user$project$AlgoliaSearch$search = _elm_lang$core$Native_Platform.outgoingPort(
	'search',
	function (v) {
		return v;
	});
var _user$project$AlgoliaSearch$results = _elm_lang$core$Native_Platform.incomingPort(
	'results',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (query) {
								...
								return A2(
									...
									function (title) {
										return A2(
											...
											function (tags) {
												return _elm_lang$core$Json_Decode$succeed(
													{text: text, title: title, tags: tags});
											},
											A2(
												_elm_lang$core$Json_Decode$field,
												'tags',
...
var _user$project$AlgoliaSearch$Model = F2(
	function (a, b) {
		return {query: a, results: b};
	});
var _user$project$AlgoliaSearch$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'Query':
				...
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$AlgoliaSearch$Model, _p1, model.results),
					_1: _user$project$AlgoliaSearch$search(_p1)
				};
			case 'Search':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$AlgoliaSearch$search(model.query)
				};
			default:
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$AlgoliaSearch$Model, model.query, _p0._0),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _user$project$AlgoliaSearch$AlgoliaResult = F2(
	function (a, b) {
		return {query: a, hits: b};
	});
var _user$project$AlgoliaSearch$emptyAlgoliaResult = A2(
	_user$project$AlgoliaSearch$AlgoliaResult,
	'',
	{ctor: '[]'});
var _user$project$AlgoliaSearch$init = {
	ctor: '_Tuple2',
	_0: A2(_user$project$AlgoliaSearch$Model, '', _user$project$AlgoliaSearch$emptyAlgoliaResult),
	_1: _elm_lang$core$Platform_Cmd$none
};
var _user$project$AlgoliaSearch$Hit = F3(
	function (a, b, c) {
		return {text: a, title: b, tags: c};
	});
var _user$project$AlgoliaSearch$Show = function (a) {
	return {ctor: 'Show', _0: a};
};
var _user$project$AlgoliaSearch$subscriptions = function (model) {
	return _user$project$AlgoliaSearch$results(_user$project$AlgoliaSearch$Show);
};
var _user$project$AlgoliaSearch$Search = {ctor: 'Search'};
var _user$project$AlgoliaSearch$Query = function (a) {
	return {ctor: 'Query', _0: a};
};
var _user$project$AlgoliaSearch$view = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				_elm_lang$html$Html$input,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$placeholder('search for a post'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onInput(_user$project$AlgoliaSearch$Query),
							_1: {ctor: '[]'}
						}
					}
				},
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _user$project$AlgoliaSearch$toHtmlList(model.results),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _user$project$AlgoliaSearch$main = _elm_lang$html$Html$program(
	{init: _user$project$AlgoliaSearch$init, view: _user$project$AlgoliaSearch$view, update: _user$project$AlgoliaSearch$update, subscriptions: _user$project$AlgoliaSearch$subscriptions})();

var Elm = {};
Elm['AlgoliaSearch'] = Elm['AlgoliaSearch'] || {};
if (typeof _user$project$AlgoliaSearch$main !== 'undefined') {
    _user$project$AlgoliaSearch$main(Elm['AlgoliaSearch'], 'AlgoliaSearch', {"types":{"unions":{"AlgoliaSearch.Msg":{"args":[],"tags":{"Query":["String"],"Show":["AlgoliaSearch.AlgoliaResult"],"Search":[]}}},"aliases":{"AlgoliaSearch.Hit":{"args":[],"type":"{ text : String, title : String, tags : List String }"},"AlgoliaSearch.AlgoliaResult":{"args":[],"type":"{ query : String, hits : List AlgoliaSearch.Hit }"}},"message":"AlgoliaSearch.Msg"},"versions":{"elm":"0.18.0"}});
}
